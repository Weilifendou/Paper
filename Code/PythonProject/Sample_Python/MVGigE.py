...
def MVBayerToBGR16(hCam, dststep, width, height, pixelformat):
	...
	psrc = c_uint()
	pdst = c_uint()
	res = MVGigE.MVBayerToBGR16(c_uint64(hCam), byref(psrc), byref(pdst), c_uint(dststep), c_uint(width), c_uint(height), pixelformat)
...
def MVBayerToRGB16(hCam, dststep, width, height, pixelformat):
	...
	psrc = c_uint()
	pdst = c_uint()
	res = MVGigE.MVBayerToRGB16(c_uint64(hCam), byref(psrc), byref(pdst), c_uint(dststep), c_uint(width), c_uint(height), pixelformat)
	return res, psrc.value, pdst.value
