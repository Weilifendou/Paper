...
void Samples_Qt_TriggerCount::drawImageForWindow()
{
	...
	ui.showImage->setPixmap(QPixmap::fromImage(m_ShowImage));
}
...
void Samples_Qt_TriggerCount::on_saveImage_clicked()
{
	...
	tImage = qt_pixmapFromWinHBITMAP(mImage.GetHBitmap()).scaled(mImage.GetWidth(), mImage.GetHeight(), Qt::KeepAspectRatio).toImage();
